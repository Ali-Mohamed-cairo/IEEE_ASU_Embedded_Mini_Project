...
Std_ReturnType MCAL_EXTI_SetPending(u8 Copy_Line)
{
	Std_ReturnType Local_FunctionStatus = E_NOT_OK;
...
void MCAL_EXTI_SetCallBack(void (*Copy_CallBack)(void))
{
	MCAL_EXTI_CallBack = Copy_CallBack;
}
